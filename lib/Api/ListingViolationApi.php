...
class ListingViolationApi
{
     ...
     * @param  int $offset The integer value input into this field controls the first listing violation in the result set that will be displayed at the top of the response. The offset and limit query parameters are used to control the pagination of the output. For example, if offset is set to 10 and limit is set to 10, the call retrieves listing violations 11 thru 20 from the resulting set of violations. Note: This feature employs a zero-based index, where the first item in the list has an offset of 0. If the listing_id parameter is included in the request, this parameter will be ignored. Default: 0 {zero) (optional)
     ...
     * @return \Ebay\Sell\Compliance\Model\PagedComplianceViolationCollection
     */
    ...
    {
        list($response) = $this->getListingViolationsWithHttpInfo($x_ebay_c_marketplace_id, $compliance_type, $offset, $listing_id, $limit, $filter);
        return $response;
    }
     ...
     * @throws \Ebay\Sell\Compliance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \Ebay\Sell\Compliance\Model\PagedComplianceViolationCollection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getListingViolationsWithHttpInfo($x_ebay_c_marketplace_id, $compliance_type = null, $offset = null, $listing_id = null, $limit = null, $filter = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Ebay\Sell\Compliance\Model\PagedComplianceViolationCollection' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Ebay\Sell\Compliance\Model\PagedComplianceViolationCollection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Ebay\Sell\Compliance\Model\PagedComplianceViolationCollection';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Ebay\Sell\Compliance\Model\PagedComplianceViolationCollection',
     ...
     *
     * @param  \Ebay\Sell\Compliance\Model\SuppressViolationRequest $body This type is the base request type of the SuppressViolation method. (required)
     *
     * @throws \Ebay\Sell\Compliance\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function suppressViolation($body)
    {
        $this->suppressViolationWithHttpInfo($body);
    }
     ...
     */
    public function suppressViolationWithHttpInfo($body)
    {
        $request = $this->suppressViolationRequest($body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suppressViolationAsync($body)
    {
        return $this->suppressViolationAsyncWithHttpInfo($body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function suppressViolationAsyncWithHttpInfo($body)
    {
        $returnType = '';
        $request = $this->suppressViolationRequest($body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function suppressViolationRequest($body)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling suppressViolation'
            );
        }
